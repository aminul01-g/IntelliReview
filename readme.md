...
- **Multi-Language Support**: Native support for Python, JavaScript, Java, C, and C++
- **AI-Powered Suggestions**: Leverages Hugging Face models (Qwen/Qwen2.5-Coder-7B-Instruct) for intelligent code improvement suggestions
- **Expert SQE Format**: Generates comprehensive, professional code review reports
- **Multiple Interfaces**: Use via CLI, REST API, or web dashboard
- **Containerized Deployment**: Full Docker support with Docker Compose orchestration
- **Advanced Analysis**: Detects bugs, security vulnerabilities, code smells, anti-patterns, and complexity issues
...
- **Python**: AST-based analysis with Pylint, Bandit, and Radon integration
- **JavaScript**: Esprima-based parsing with weak equality and promise error detection
- **Java**: Scanner bug detection, loop condition analysis, style checking
- **C/C++**: Memory leak detection, unsafe function detection, virtual destructor checks
